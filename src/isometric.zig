...
fn orthToIsoWrapIncrementY(tile_pix_height: f32) f32 {
    return tile_pix_height / 2;
}
...
fn rectangleHeight(tile_pix_height: f32) f32 {
    return tile_pix_height / 2;
}
...
fn tilePosition(iso_x: f32, iso_y: f32, tile_pix_width: f32, tile_pix_height: f32) ?struct { tile_x: f32, tile_y: f32 } {
    const rectangle_pix_width = rectangleWidth(tile_pix_width);
    const rectangle_pix_height = rectangleHeight(tile_pix_height);
    ...
    if (diagonal_direction == .raising and rectangle_side == .upper) {return .{.tile_x = rectangle_position_x - rectangle_pix_width, .tile_y = rectangle_position_y - rectangle_pix_height};}
    if (diagonal_direction == .raising and rectangle_side == .lower) {return .{.tile_x = rectangle_position_x , .tile_y = rectangle_position_y };}
    if (diagonal_direction == .falling and rectangle_side == .upper) {return .{.tile_x = rectangle_position_x, .tile_y = rectangle_position_y - rectangle_pix_height};}
    if (diagonal_direction == .falling and rectangle_side == .lower) {return .{.tile_x = rectangle_position_x - rectangle_pix_width, .tile_y = rectangle_position_y};}
    return null;
}
...
pub const Iso = struct {
    ...
    pub fn new(tile_pix_width: f32, tile_pix_height: f32) @This() {
        ...
        this.wrap_increment_y = orthToIsoWrapIncrementY(tile_pix_height);
        return this;
    }
